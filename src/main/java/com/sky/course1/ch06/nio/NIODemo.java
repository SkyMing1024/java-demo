...
public class NIODemo {
    ...
    public static void test2() throws IOException {
        ...
        FileOutputStream out= new FileOutputStream("/Users/sky-mbp16/CODING/FILE_UP_LOAD/test copy1.mp4");
        //获取通道
    ...
    // 直接缓冲区中，使用MappedByteBuffer修改文件内容
    public static void test_modify() throws IOException {
        RandomAccessFile raf = new RandomAccessFile("/Users/sky-mbp16/CODING/FILE_UP_LOAD/abc.txt","rw");
