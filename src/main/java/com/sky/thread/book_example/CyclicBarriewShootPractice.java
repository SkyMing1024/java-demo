...
import com.sky.util.Tools;

import java.util.concurrent.BrokenBarrierException;
import java.util.concurrent.CyclicBarrier;

public class CyclicBarriewShootPractice {
  // 参与打靶训练的全部士兵
  final Soldier[][] rank;
  // 靶的个数，即每排中士兵的个数
  final int N;
  ...
  public CyclicBarriewShootPractice(int N, final int lineCount, int lasting) {
    this.N = N;
  ...
  public static void main(String[] args) throws InterruptedException {
    CyclicBarriewShootPractice sp = new CyclicBarriewShootPractice(4, 5, 24);
    sp.start();
  }
